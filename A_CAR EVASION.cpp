...
void instructions() {
    ...
    cout << "| 3. The game will end when you touch the other car.                          |" << endl;
    cout << "| 4. Your score will be displayed on the bot of the screen.                   |" << endl;
    cout << "===============================================================================" << endl;
...
void games() {
    ...
    do {
        ...
        gotoxy(0, 4);cout << "±±                           ±±";
        gotoxy(0, 5);cout << "±±                           ±±";
        gotoxy(0, 6);cout << "±±  Press 'space' to start   ±±";
        gotoxy(0, 7);cout << "±±                           ±±";
        gotoxy(0, 8);cout << "±±                           ±±";
        gotoxy(0, 9);cout << "±±                           ±±";
        gotoxy(0, 10);cout << "±±                           ±±";
